...
import com.l2journey.gameserver.taskmanagers.RespawnTaskManager;
...
public class Spawn extends Location
{
	...
	public Spawn(NpcTemplate template) throws ClassNotFoundException, NoSuchMethodException, ClassCastException
	{
		...
		_constructor = Class.forName("com.l2journey.gameserver.model.actor.instance." + _template.getType()).asSubclass(Npc.class).getConstructor(NpcTemplate.class);
	}
